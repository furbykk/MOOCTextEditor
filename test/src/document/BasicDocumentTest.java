...
public class BasicDocumentTest {
    ...
    public void testGetNumWords() {
        String text = "marc is my 1 son.";
        Document doc = new BasicDocument(text);

        System.out.println(text);
        System.out.println("num of words " + doc.getNumWords());

        text = "i, challenge, you, to, 2.5, battle, of!? wits";
    ...
    @Test
    public void getGetNumSentencesText() {

        String text = "marc is my 1.6 son. he is smart. Is he tall? \"No, he isn't.\"";
        Document doc = new BasicDocument(text);

        System.out.println(text);
        System.out.println("num of sentences " + doc.getNumSentences());
    }

    @Test
    public void testCountSyllables() {
        Document d = new BasicDocument("");
        String word = "contiguous";
        System.out.println("Number of syllables of " + word + " is " + d.countSyllables(word));
    }
