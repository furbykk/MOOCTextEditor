...
//        boolean found = false;
        ...
        while (queue.size()>0) {
            ...
            List<String> neighbours = nw.distanceOne(node.getWord(), true);
//            System.out.println("Found neighbour for " + node.getWord() + ": " + neighbours.toArray());
            for(String neighbour : neighbours) {
                WPTreeNode child = node.addChild(neighbour);
